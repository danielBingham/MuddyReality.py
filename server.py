...
# Run the Game Server
#
# Sets up the game store, library, interpreters and commands, then runs the
# primary game loop.  Invoked through `main.py`:
#
...
def run(arguments):
    ...
    arguments: argparse.Namespace
        The parsed command line arguments for the `server` command, as defined
        in `main.py`.
